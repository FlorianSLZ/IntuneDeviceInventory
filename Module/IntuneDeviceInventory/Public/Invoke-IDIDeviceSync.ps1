function Invoke-IDIDeviceSync {
    ...
    if($All){
        if($global:IDIDevices_all){$global:IDIDevices_all | ForEach-Object{ Invoke-IDIDeviceSync -IDIDevice $_}}
        ...
        if($global:IDIDevices_all){
            ...
            $Devices2Sync | ForEach-Object{ Invoke-IDIDeviceSync -IDIDevice $_}
        }
